...
const accordionIndex = reactive([false, false, false]);
...
<template>
    ...
    <div id="accordion-open" data-accordion="open">
        <h2 id="accordion-open-heading-1">
            <button @click="accordionIndex[0] = !accordionIndex[0]" type="button"
        ...
        <div id="accordion-open-body-1" v-show="accordionIndex[0]" aria-labelledby="accordion-open-heading-1">
        ...
        <h2 id="accordion-open-heading-2">
            <button @click="toggle(1)" type="button"
        ...
        <div id="accordion-open-body-2" v-show="accordionIndex[1]" aria-labelledby="accordion-open-heading-2">
        ...
        <h2 id="accordion-open-heading-3">
            <button @click="toggle(2)" type="button"
        ...
        <div id="accordion-open-body-3" v-show="accordionIndex[2]" aria-labelledby="accordion-open-heading-3">
