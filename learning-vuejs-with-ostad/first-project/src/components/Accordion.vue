...
<template>
    ...
    <div id="accordion-open" data-accordion="open">
        <h2 id="accordion-open-heading-1">
            <button @click="accordionIndex = 0" type="button"
        ...
        <h2 id="accordion-open-heading-2">
            <button @click="accordionIndex = 1" type="button"
        ...
        <div id="accordion-open-body-2" :class="accordionIndex == 1 ? '' : 'hidden'" aria-labelledby="accordion-open-heading-2">
        ...
        <h2 id="accordion-open-heading-3">
            <button @click="accordionIndex = 2" type="button"
        ...
        <div id="accordion-open-body-3" :class="accordionIndex == 2 ? '' : 'hidden'" aria-labelledby="accordion-open-heading-3">
